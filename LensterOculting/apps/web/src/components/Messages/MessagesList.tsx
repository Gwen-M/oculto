...
const isZkAddress = (msg: any) => {
  console.log(msg, msg.includes('zkbob_polygon:'));
  return msg.includes('zkbob_polygon:');
};

const parseZkAddress = (msg: string) => {
  return msg.split(':')[1];
};
      ...
      <div className="flex max-w-[60%]">
        ...
        >
          ...
          >
            ...
            {isZkAddress(message.content) ? (
              <SendBob
                zkAddress={parseZkAddress(message.content)}
